...
for var in {ES_DOMAIN_ARN,ES_DOMAIN_ENDPOINT,PROXY_DNS,PROXY_IP,COGNITO_USERPOOL,COGNITO_PROVIDERNAME,COGNITO_PROVIDERURL,COGNITO_CLIENTID}; do echo "$var=${!var}"; done
fi
